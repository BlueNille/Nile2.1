...
//                        holder.itemView.setOnClickListener(new View.OnClickListener(){ //added on video 21
//                            @Override
//                            public void onClick(View view)//when one book is clicked sends user to details of book
//                            {
//                                Intent intent =  new Intent (HomeActivity.this, ProductDetailsActivity.class);
//                                intent.putExtra("pid", model.getPid()); // gets the products id that the user clicked on
