...
import com.example.nile2.ViewHolder.CartViewHolder;
import com.example.nile2.Model.Cart;
...
public class CartActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //need new layout to display items to the user
    }

    @Override
    protected void onStart() //retrieving data from database to display on cartActivity
    {
        super.onStart();
